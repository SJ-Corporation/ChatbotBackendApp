...
link.rel = 'stylesheet';
link.type = 'text/css';
link.href = 'https://chat-bot-web-app.azurewebsites.net/startup.css';
...
chatButton.innerHTML = 'Ask Bot <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-robot" viewBox="0 0 16 16">'+
